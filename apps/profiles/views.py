...
# Note: Legacy client profile views have been removed.
# All client profile functionality now uses the API-driven implementation in client_profile/views_api.py
