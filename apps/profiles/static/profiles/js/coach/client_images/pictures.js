...
//     const apiUrl = '/profiles/api/v1/coach-client-pictures/';
...
//     // Fetch and display all client pictures
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modal = new bootstrap.Modal(modalElement);  // Initialize Bootstrap modal for picture
    ...
    const confirmDeleteButton = document.getElementById('confirm-delete-button');
    let deletePictureId = null;  // Store picture ID to be deleted
